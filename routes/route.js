...
const orders=require("../models/orders2026"); // updated for 2023*************
...
router.post("/placeorder",(req,res)=>{
  ...
  var gst=0;
  //if (originalText.location!="Tamil Nadu" && originalText.location!="Puducherry")
      gst= Math.round(originalText.payamt*(18/100));
